...
import { FiUserPlus, FiMail, FiSearch, FiX, FiAlertCircle } from "react-icons/fi";
          ...
          {modalType === "existing" ? (
            ...
            <div className="space-y-4">
                ...
                <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-700 text-sm mt-1">
                      No user exists with email: <span className="font-mono">{searchEmail}</span>
                    </p>
              ...
              <div className="flex gap-3 pt-4">
                ...
                >
                  {foundUser ? "Add to Society" : "Search User First"}
                </button>
              </div>
            </div>
          ) : (
            ...
            <div className="space-y-4">
              ...
              <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
                <p className="text-sm text-purple-700 flex items-start gap-2">
                  ...
                  <span>
                    An invitation email will be sent to activate the account. The user can set their password and join the society.
                  </span>
                </p>
              </div>
