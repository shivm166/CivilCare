          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows="2"
                className="w-full px-3 py-2 sm:px-4 sm:py-2 text-sm sm:text-base border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-transparent resize-none"
