...
export const getBuildingById = async (buildingId) => {
  try {
    const response = await axiosInstance.get(`/admin/v1/building/${buildingId}`);
    return response.data;
  } catch (error) {
...
export const createBuilding = async (buildingData) => {
  try {
    const response = await axiosInstance.post("/admin/v1/building", buildingData);
    return response.data;
  } catch (error) {
...
export const deleteBuilding = async (buildingId) => {
  try {
    const response = await axiosInstance.delete(`/admin/v1/building/${buildingId}`);
    return response.data;
  } catch (error) {
...
export const deleteUnit = async (unitId) => {
  try {
    const response = await axiosInstance.delete(`/admin/v1/building/unit/${unitId}`);
    return response.data;
  } catch (error) {
